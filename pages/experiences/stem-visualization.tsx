      ...
      <div className="py-3">
        ...
        <div className="w-10/12 mx-auto m-3 bg-white rounded-2xl shadow-lg p-5 max-w-3xl max-sm:w-full duration-300 max-sm:shadow-none dark:bg-black">
          <p className="m-3 py-2 text-black dark:text-white">
            ...
            in which we work with professors who come up with the project
          ...
          <p className="m-3 py-2 text-black dark:text-white">
            ...
            application that is currently running on the school&apos;s server.
            The issue that the project was trying to solve is the high dropout
            rate of engineering schools. Students first entering might get
            frustrated from looking at all the complicated concepts and get
            scared of what would happen moving forward. To help those students,
            we try to create a web app that can show the introduction level
          ...
          <p className="m-3 py-2 text-black dark:text-white">
            ...
            engineering students by demonstrating different processes on
            chemistry datasets. We used Python as our main coding language
            because it is one of the most popular languages in the machine
            learning field. As the final project is a web application, we then
            chose Bokeh as our module builder. Bokeh allows us to code in Python
            and translates to HTML and CSS for content and JavaScript for
            interactivity. The machine learning library we used was Scikit-learn
            because it is considered an easy-to-learn and easy-to-use library.
          </p>
          <p className="m-3 py-2 text-black dark:text-white">
