      ...
      <div className="py-3">
        ...
        <div className="w-10/12 mx-auto m-3 bg-white rounded-2xl shadow-lg p-5 max-w-3xl max-sm:w-full duration-300 max-sm:shadow-none dark:bg-black">
          <p className="m-3 py-2 text-black dark:text-white">
            ...
            websites seems essential to showcase ourselves to a broader
            audience. I started this project in the fall of 2022. Not only
            because of the need of having a website to express my personal
            experiences but also as a good way to learn about React.js and its
            framework Next.js, as well as Tailwind CSS.
          </p>
          ...
          <p className="m-3 py-2 text-black dark:text-white">
            ...
            incapable of server-side rendering. The initial page is just an
            empty HTML boilerplate, and the content gets injected after
            JavaScript loads. Therefore the initial page load is likely to be
            slow, and it&apos;s not friendly for search engines to index our
            pages. We usually want search engines to properly parse our pages to
            grow in popularity, so a framework that can render most of the
            content without the help of Javascript is likely to work better.
            Next.js comes into play by building pages during build time and
            serving prebuilt HTML for the initial page load, which will be much
            faster and more efficient for my use case.
          </p>
          <p className="m-3 py-2 text-black dark:text-white">
