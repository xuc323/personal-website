...
export default function Navbar() {
  ...
  return (
    <header className="w-full bg-white border-b-1 shadow-md font-serif dark:bg-black">
      <nav className="flex justify-between items-center max-w-4xl mx-auto gap-8 p-2 max-sm:flex-col max-sm:gap-0 transition-all">
        <div className="flex justify-between w-full items-center">
          <Link href="/" className="px-3">
            <svg
              ...
              className="stroke-white fill-black dark:stroke-black dark:fill-white transition-all duration-300"
            >
        ...
        {/* Full menu */}
        <ul
          className={`flex gap-4 p-0 m-0 list-none text-gray-500 dark:text-gray-200 ${
