...
export default function Navbar() {
  ...
  return (
    <header>
      <nav className="flex justify-between items-center gap-8 px-4 border-b-2 shadow-md max-sm:flex-col max-sm:gap-0 transition-all">
        <div className="flex justify-between w-full items-center">
          ...
          {/* Burger menu */}
          <button
            className="hidden flex-col h-12 w-12 justify-center items-center group max-sm:flex"
            onClick={() => {
              setIsOpen(!isOpen);
            }}
          >
        ...
        >
          <li className="max-sm:border-t-2 text-center">
            <Link
              href="/project"
              className="no-underline h-full w-20 text-center inline-block items-center p-3 transition-all hover:text-black"
            >
              Project
            </Link>
          </li>
