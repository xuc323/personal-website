...
export default function Navbar() {
  ...
  return (
    <header className="w-full border-b-2 bg-white font-serif sticky top-0 dark:bg-black">
        ...
        <div className="flex justify-between w-full items-center">
          <Link href="/" className="px-3">
            <svg
              ...
              className="stroke-white fill-black dark:stroke-black dark:fill-white duration-300"
            >
