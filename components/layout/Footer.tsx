...
export default function Footer() {
  ...
  return (
    <footer className="absolute bottom-0 w-full border-t-2 bg-gray-100 pb-4 pt-3 text-center font-serif text-black dark:bg-black dark:text-white max-sm:px-2">
