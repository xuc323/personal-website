/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 679dc7aad07efd55f34ae1f9adf5865f)
// Runtime types generated with workerd@1.20250813.0 2025-08-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_INC_CACHE_KV: KVNamespace;
		NEXTJS_ENV: string;
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler */;
		WORKER_SELF_REFERENCE: Fetcher /* personal-website */;
		ASSETS: Fetcher;
	}
}
